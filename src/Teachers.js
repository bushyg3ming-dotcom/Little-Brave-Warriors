        ...
        <div style={{maxWidth: '900px', textAlign: 'center'}}>
          ...
          <div style={{display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: '20px', marginTop: '30px'}}>
            <div style={{background: 'rgba(255, 255, 255, 0.8)', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', minWidth: '250px', textAlign: 'center'}}>
              <img src="/teacher image folder/camy.jpg" alt="Camy Fourie" style={{borderRadius: '50%', marginBottom: '10px', width: '100px', height: '100px', objectFit: 'cover'}} />
              <h3>Camy Fourie</h3>
            ...
            <div style={{background: 'rgba(255, 255, 255, 0.8)', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', minWidth: '250px', textAlign: 'center'}}>
              <img src="/teacher image folder/warren.jpg" alt="Warren Fourie" style={{borderRadius: '50%', marginBottom: '10px', width: '100px', height: '100px', objectFit: 'cover'}} />
              <h3>Warren Fourie</h3>
            ...
            <div style={{background: 'rgba(255, 255, 255, 0.8)', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', minWidth: '250px', textAlign: 'center'}}>
              <img src="/teacher image folder/thando.jpg" alt="Teacher Thando" style={{borderRadius: '50%', marginBottom: '10px', width: '100px', height: '100px', objectFit: 'cover'}} />
            ...
            <div style={{background: 'rgba(255, 255, 255, 0.8)', padding: '20px', borderRadius: '10px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)', minWidth: '250px', textAlign: 'center'}}>
              <img src="/teacher image folder/lala.jpg" alt="Teacher Lala" style={{borderRadius: '50%', marginBottom: '10px', width: '100px', height: '100px', objectFit: 'cover'}} />
              <h3>Teacher Lala</h3>
